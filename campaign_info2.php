...
$campaign_name_capital = ucfirst($_POST['campaign_name']);
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class = "row">
            ...
            <div class = "col-md-11">
              <h1 class="mt-4">&nbsp; $campaign_name_capital </h1>
            </div>
          </div>
          ...
          <p>Posted on $theDate</p>

          <hr>

          <!-- Post Content -->
          <p class="lead">
            <b>Description of Campaign:</b><br>
             $campaign_desc
          </p>
...
HEREDOC;
$trimmed= str_replace(' ', '', $campaign_name);

file_put_contents('' . $trimmed .'.html', $html);

header('location:'. $trimmed . '.html');
exit;
